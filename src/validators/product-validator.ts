...
export const createProductSchema = z.object({
  ...
  shippingPrice: z.coerce
    .number()
    .positive()
    .max(100, "Shipping price is too long")
    .optional(),
  ...
  compatibleModel: z.array(z.string().min(1, "Please select a model")),
  compatibleSubmodel: z.array(z.string().min(1, "Please select a sub model")),
  //   compatibleEngine: z.array(z.string().min(1, "Please select a engine")),
  compatibleYear: z.array(z.number().min(1, "Please select a year")),
});
